package com.example.fitme.Activities.Oxygen;
...
import com.example.fitme.Activities.MainActivity.MainActivity;
...
//            Log.d("sumblue", " sumblue"+sumblue);
            ...
            if (totaltime >= 30) {
                ...
                double HRfreq = com.example.fitme.Math.Fft.FFT(red, counter, SamplingFreq);
