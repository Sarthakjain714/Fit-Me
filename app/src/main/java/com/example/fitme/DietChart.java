...
public class DietChart extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(titleRec.equals("Healthy")){
            ...
            arrayList.add(new Menu("Monday","DietChart"));
            ...
            arrayList.add(new Menu("Thursday","DietChart"));
            ...
            arrayList.add(new Menu("Friday","DietChart"));
            arrayList.add(new Menu("Breakfast"+"\n"+"(8:00-8:30AM)","Chapati (2) + Daal (1 cup)"));
            ...
            arrayList.add(new Menu("Saturday","DietChart"));
